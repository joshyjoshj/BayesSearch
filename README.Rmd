...
For the rest of the examples we will use example matrices created by `generate_sample_matrix()`. This will assing 3 matrices to the global environment for use in examples 
